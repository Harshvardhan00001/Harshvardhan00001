...
![GitHub followers](https://img.shields.io/github/followers/YOURUSERNAME?label=Followers&style=flat&color=302b63&labelColor=0f0c29)
![GitHub stars](https://img.shields.io/github/stars/YOURUSERNAME?label=Total%20Stars&style=flat&color=302b63&labelColor=0f0c29)
...
const developer = {
  ...
  currentFocus: "Building secure, scalable full-stack applications",
...
| 🎖️ Certificate | 🏢 Issuer | 📅 Status |
|:---|:---|:---|
| Virtual Intern | PBEL | ✅ Certified |
| MERN Stack Development | Self-taught + Projects | ✅ Active |
| Cybersecurity Fundamentals | Currently Learning | 🔄 In Progress |
...
```bash
$ whoami
  → MERN Stack Developer transitioning into Cybersecurity
